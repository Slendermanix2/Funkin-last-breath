...
class Slendermanix2Option extends Option
{
       public function new(desc:String)
	{
		super();
	...
	{
		trace("switch");
		FlxG.openURL('https://gamebanana.com/members/1790492');
		return false;
	}

	private override function updateDisplay():String
	{
		return "Slendermanix2";
	}
}

class TheIndieDavOption extends Option
{
       public function new(desc:String)
	{
		super();
	...
	{
		trace("switch");
		FlxG.openURL('https://www.youtube.com/channel/UCEhx42eNJ5IgyOjRTq0CqOA');
		return false;
	}

	private override function updateDisplay():String
	{
		return "The Indie Dav";
	}
}

class TobyFoxOption extends Option
{
       public function new(desc:String)
	{
		super();
	...
	{
		trace("switch");
		FlxG.openURL('https://twitter.com/tobyfox?lang=en');
		return false;
	}
...
class ZerJokOption extends Option
{
       public function new(desc:String)
	{
		super();
	...
	{
		trace("switch");
		FlxG.openURL('https://www.youtube.com/channel/UC0JPIp15LOvqoxazgYtJM0g');
		return false;
	}
...
class BenLabOption extends Option
{
       public function new(desc:String)
	{
		super();
	...
	{
		trace("switch");
		FlxG.openURL('https://soundcloud.com/benlabthesecond');
		return false;
	}
...
class NathanSOption extends Option
{
       public function new(desc:String)
	{
		super();
	...
	{
		trace("switch");
		FlxG.openURL('https://twitter.com/NathanS_YT');
		return false;
	}
...
class KadeDevOption extends Option
{
       public function new(desc:String)
	{
		super();
