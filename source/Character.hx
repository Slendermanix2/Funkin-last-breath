	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'parents-christmas':
				...
				playAnim('idle');
			case 'sans':
				frames = Paths.getSparrowAtlas('SANS', 'shared');
				animation.addByPrefix('idle', 'sans Idle Dance', 24, false);
				animation.addByPrefix('singUP', 'sans Up note', 24, false);
				animation.addByPrefix('singLEFT', 'sans Note Right', 24, false);
				animation.addByPrefix('singRIGHT', 'sans NOTE LEFT', 24, false);
				animation.addByPrefix('singDOWN', 'sans Down Note', 24, false);
				
				addOffset('idle');
		        addOffset("singUP", 0, 8);
		        addOffset("singRIGHT", -2, -6);
		        addOffset("singLEFT", 96, 3);
